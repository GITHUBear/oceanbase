...
int ObInnerTableSchema::all_backup_log_archive_status_history_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ...
    ADD_COLUMN_SCHEMA_T("start_piece_id", //column_name
      ...
      false, //is_nullable
      false, //is_autoincrement
      start_piece_id_default,
      start_piece_id_default); //default_value
  }
  ...
  if (OB_SUCC(ret)) {
    ...
    ADD_COLUMN_SCHEMA_T("backup_piece_id", //column_name
      ...
      false, //is_nullable
      false, //is_autoincrement
      backup_piece_id_default,
      backup_piece_id_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(FLAT_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_COMPACT_MYSQL);
...
int ObInnerTableSchema::all_tenant_backup_task_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ...
    ADD_COLUMN_SCHEMA_T("start_replay_log_ts", //column_name
      ...
      false, //is_nullable
      false, //is_autoincrement
      start_replay_log_ts_default,
      start_replay_log_ts_default); //default_value
  }
...
int ObInnerTableSchema::all_restore_progress_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("white_list", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
...
int ObInnerTableSchema::all_table_v2_history_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ObObj mv_log_table_id_default;
    mv_log_table_id_default.set_int(0);
    ADD_COLUMN_SCHEMA_T("mv_log_table_id", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      true, //is_nullable
      false, //is_autoincrement
      mv_log_table_id_default,
      mv_log_table_id_default); //default_value
  }

  if (OB_SUCC(ret)) {
    ObObj cur_applied_seq_no_default;
    cur_applied_seq_no_default.set_int(0);
    ADD_COLUMN_SCHEMA_T("cur_applied_seq_no", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
      ...
      true, //is_nullable
      false, //is_autoincrement
      cur_applied_seq_no_default,
      cur_applied_seq_no_default); //default_value
  }
  table_schema.set_index_using_type(USING_BTREE);
  table_schema.set_row_store_type(FLAT_ROW_STORE);
  table_schema.set_store_format(OB_STORE_FORMAT_COMPACT_MYSQL);
...
int ObInnerTableSchema::all_backup_backupset_job_schema(ObTableSchema &table_schema)
{
  ...
  if (OB_SUCC(ret)) {
    ADD_COLUMN_SCHEMA("max_backup_times", //column_name
      ++column_id, //column_id
      0, //rowkey_id
      0, //index_id
      0, //part_key_pos
