...
public:
  ...
  uint64_t get_cur_applied_seq_no() const {
    return cur_applied_seq_no_;
  }
  void set_cur_applied_seq_no(uint64_t seq_no) {
    cur_applied_seq_no_ = seq_no;
  }
...
protected:
  ...
  uint64_t mv_log_table_id_;       // the materialized view log table id
  uint64_t cur_applied_seq_no_;    // for refresh
