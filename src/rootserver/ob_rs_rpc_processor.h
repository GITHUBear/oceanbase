...
DEFINE_DDL_RS_RPC_PROCESSOR(obrpc::OB_EXPDP_TABLE, ObRpcExpdpTableP, expdp_table(arg_));
DEFINE_DDL_RS_RPC_PROCESSOR(obrpc::OB_IMPDP_TABLE, ObRpcImpdpTableP, impdp_table(arg_));
